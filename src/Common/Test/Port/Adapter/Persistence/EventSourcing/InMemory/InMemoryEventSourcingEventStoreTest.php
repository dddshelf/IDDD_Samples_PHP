...
namespace SaasOvation\Common\Test\Port\Adapter\Persistence\EventSourcing\InMemory;
...
class InMemoryEventSourcingEventStoreTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var EventStore
     */
    ...
    public function testEventsSince()
    {
        ...
        $loggedEvents = $this->eventStore->eventsSince(1);
